...
const Canvas = (props) => {
  ...
  const gridProps = { setgrid0Props, setgrid1Props, setgrid2Props, setgrid3Props };
  const [rotationVal, setRotationVal] = useState(0);
  const handleRotationChange = (val) => {
    setSelectedAngle(val, selectedGrid, grids, gridProps);
    setRotationVal(val);
  };
  ...
  const [zoomVal, setZoomVal] = useState(1);
  const handleZoomChange = (val) => {
    setSelectedZoom(val, selectedGrid, grids, gridProps);
    setZoomVal(val);
  };
  ...
  const [horizontalVal, setHorizontalVal] = useState(1);
  const handleHorizontalChange = (val) => {
    setSelectedHorizontal(val, selectedGrid, grids, gridProps);
    setHorizontalVal(val);
  };
  ...
  const [verticalVal, setVerticalVal] = useState(1);
  const handleVerticalChange = (val) => {
    setSelectedVertical(val, selectedGrid, grids, gridProps);
    setVerticalVal(val);
  };
